...
if __name__ == '__main__':
    ...
    with open('complex_sentence_list.pkl', mode='rb') as file:
        complex_sentences = pickle.load(file)[2880:]

    with open('simple_sentence_list.pkl', mode='rb') as file:
        simple_sentences = pickle.load(file)[2880:]
    ...
    save_file = open('only_trans_result.txt', mode='w', encoding='utf-8')
