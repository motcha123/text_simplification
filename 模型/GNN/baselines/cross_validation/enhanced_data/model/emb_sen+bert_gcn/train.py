...
if __name__ == '__main__':
    ...
    # model.load_state_dict(torch.load('emb_sen+bert_gcn.pth'))
    ...
    loss_path = 'loss_emb_sen+bert_gcn_3layer.txt'
    ...
    for i in range(300):
        ...
        torch.save(model.state_dict(), 'emb_sen+bert_gcn_3layer.pth')  # 保存模型参数
        # print('模型保存！！！')
